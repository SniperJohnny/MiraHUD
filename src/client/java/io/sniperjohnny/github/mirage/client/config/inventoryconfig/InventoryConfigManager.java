package io.sniperjohnny.github.mirage.client.config.inventoryconfig;
...
public class InventoryConfigManager {
    ...
    private static final File CONFIG_FILE = FabricLoader.getInstance()
            ...
            .resolve("configs")
            .resolve(Mirage.MOD_ID + "_inventoryconfig.json")
            .toFile();
    ...
    public static void load() {
        ...
        try (FileReader reader = new FileReader(CONFIG_FILE)) {
            ...
            System.err.println("[" + Mirage.MOD_ID + "] Failed to load client config, using defaults.");
            currentInvConfig = new Inventoryconfig();
        }
    }
    ...
    public static void save() {
        ...
        try (FileWriter writer = new FileWriter(CONFIG_FILE)) {
            ...
            System.err.println("[" + Mirage.MOD_ID + "] Failed to save client config.");
        }
    }
}