...
public class OverlayConfig {
    ...
    public enum Anchor {
        TOP_LEFT("anchor.mirage.top_left", "Top Left"),
        TOP_RIGHT("anchor.mirage.top_right", "Top Right"),
        BOTTOM_LEFT("anchor.mirage.bottom_left", "Bottom Left"),
        BOTTOM_RIGHT("anchor.mirage.bottom_right", "Bottom Right"),
        CENTER("anchor.mirage.center", "Center");
